      ...
      <div className="flex justify-center">
        <div className="h-1/2 bg-neutral-800 mx-10 rounded-xl shadow-neutral-800 shadow-2xl p-10">
          ...
          <p className="text-pico text-l font-taviraj font-bold">
            ...
            a company that has a good and nuturing environment is ideal. The
            fact that the company makes use of several coding langauges and
            frameworks will allow me to grow to become a full stack developer.
          </p>
        </div>
      </div>
    </div>
